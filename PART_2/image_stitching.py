...
match_img12 = cv2.drawMatches(image_list[0], keypoints[0], image_list[1], keypoints[1], good_matches12, None, flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
cv2.imwrite("output_images/keypoint_matching_left_center.jpg", match_img12)
match_img23 = cv2.drawMatches(image_list[1], keypoints[1], image_list[2], keypoints[2], good_matches23, None, flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
